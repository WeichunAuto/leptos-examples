...
#[server]
pub async fn add_or_update_users(users_dto: UsersDto) -> Result<bool, ServerFnError> {
    ...
    #[cfg(feature = "ssr")]
    {
        ...
        let rt = users::Entity::update(users::ActiveModel {
            id: Set(users_dto.id.unwrap() as i64),
        ...
        match rt {
            ...
            Err(DbErr::RecordNotUpdated) => {
                tracing::error!("User id: {} not found", users_dto.id.unwrap());
                Ok(false)
            }
            Err(e) => {
